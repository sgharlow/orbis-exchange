...
> "44 tests" counts were the at-fix-time numbers; the full suite is **135 green**
> now (db 54 · web 36 · worker 45). The diagnosis and root cause are otherwise unchanged.
