...
> "44 tests" counts were the at-fix-time numbers; the full suite is **143 green**
> now (db 55 · web 36 · worker 52). The diagnosis and root cause are otherwise unchanged.
